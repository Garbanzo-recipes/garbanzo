<template>
  <div class="about">
    <h1 class="is-size-3">About Garbanzo</h1>
    <p>
    ...
    <p>
      For more information, please have a look at the projects page at Github:
      <a href="https://github.com/Garbanzo-recipes/garbanzo">
